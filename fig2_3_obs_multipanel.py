...
# open the datasets
ERA5_trend_masked = xr.open_dataset('data/obs/era5_anom_trendMasked.nc')
ERA5_aa = xr.open_dataset('data/era5_anom_aa.nc')

HadCRUT5_trend_masked = xr.open_dataset('data/obs/HadCRUT5_anom_trendMasked.nc')
HadCRUT5_aa = xr.open_dataset('data/HadCRUT5_anom_aa.nc')

Gistemp_trend_masked = xr.open_dataset('data/obs/gistemp_anom_trendMasked.nc')
Gistemp_aa = xr.open_dataset('data/gistemp_anom_aa.nc')

BerkeleyEarth_trend_masked = xr.open_dataset('data/obs/BerkeleyEarth_anom_trendMasked.nc')
...
plt.savefig('figures/fig2_obs_subplots_temp_trend', dpi=300, bbox_inches='tight')
plt.close()

# plot multi-panel Arctic Amplification
plot_multipanel_AA(datasets_aa, arctic_lower, subplot_labels)
plt.savefig('figures/fig3_obs_subplots_aa.png', dpi=300, bbox_inches='tight')
plt.close()